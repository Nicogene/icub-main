...
YCM_PACKAGE_URL_jammy=$YCM_PACKAGE_URL_focal
...
YARP_PACKAGE_URL_jammy=$YARP_PACKAGE_URL_focal

APT_OPTIONS="-q -y"

SUPPORTED_DISTRO_LIST="buster jammy focal"
